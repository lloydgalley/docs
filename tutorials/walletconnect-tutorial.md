...
We will learn how to connect Alltra cash wallet to various fuse DApps through WalletConnect feature and add liquidity to Fuseswap through Alltra cash wallet.
...
Open your Alltra cash wallet on your phone and the interface shown will be similar to the one shown in the image below.
...
Now click on “Pool” and then on “Add liquidity”. Select ALL as your first token and fUSD as the second token from the dropdown. Enter the amount of ALL you want to provide the liquidity for and the corresponding amount of fUSD that should be added will automatically show up according to the price of ALL.  
...
Once the transaction is confirmed on-chain, click on “Supply” and approve the transaction. You will receive the liquidity pool tokens on your wallet which can be checked under tokens through [www.alltra.global](http://www.alltra.global/) on your wallet address.
